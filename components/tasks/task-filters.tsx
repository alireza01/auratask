  ...
  return (
    <div className="p-4 bg-muted/50 rounded-lg space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
        {/* Group Filter Select */}
        <Select value={filters.filterGroup || ""} onValueChange={(v) => setFilter({ filterGroup: v || null })}>
          <SelectTrigger>
        ...
        {/* Tag Filter Select */}
        <Select value={filters.filterTag || ""} onValueChange={(v) => setFilter({ filterTag: v || null })}>
          <SelectTrigger>
